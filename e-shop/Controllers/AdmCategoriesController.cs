...
namespace e_shop.Controllers
{
    public class AdmCategoriesController : Controller
    {
        ...
        public AdmCategoriesController(Customerwebsite1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(Category category, IFormFile pic)
        {
            ...
            {
                string FilePath = Path.Combine(Directory.GetCurrentDirectory(), @"wwwroot\DataFiles\category", FileName);
